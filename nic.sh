...
echo "3. Optimize NIC queue"
echo "4. Uninstall other kernel"
echo "5. Rollback TCP optimization"

read -p "Please select [1-5]: " num

case "$num" in
    1) install_xanmod_kernel ;;
    2) apply_tcp_optimization ;;
    3) optimize_nic_queue ;;
    4) uninstall_other_kernels ;;
    5) rollback_tcp_optimization ;;
    *) exit 1 ;;
esac
